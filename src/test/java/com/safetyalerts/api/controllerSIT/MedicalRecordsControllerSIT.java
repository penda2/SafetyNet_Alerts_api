...
public class MedicalRecordsControllerSIT {
	...
	public void testGetMedicalRecords() throws Exception {
		...
		MvcResult result = mockMvc.perform(
				MockMvcRequestBuilders.get("/medicalrecords").contentType(MediaType.APPLICATION_JSON_VALUE).content(medicalRecordsJson))
				.andReturn();
	...
	public void testCreateMedicalRecords() throws Exception {
		...
		MvcResult result = mockMvc.perform(
				MockMvcRequestBuilders.post("/medicalrecords/create").contentType(MediaType.APPLICATION_JSON_VALUE).content(medicalRecordsJson))
				.andReturn();
	...
	public void testUpdateMedicalRecords() throws Exception {
		...
		String medicalRecordsJson = objectMapper.writeValueAsString(medicalRecords);
		MvcResult result = mockMvc.perform(
				MockMvcRequestBuilders.put("/medicalrecords/1").contentType(MediaType.APPLICATION_JSON_VALUE).content(medicalRecordsJson))
				.andReturn();
	...
	public void testGetMedicalRecordsById() throws Exception {
		...
		String medicalRecordsJson = objectMapper.writeValueAsString(medicalRecords);
		MvcResult result = mockMvc.perform(
				MockMvcRequestBuilders.get("/medicalrecords/1").contentType(MediaType.APPLICATION_JSON_VALUE).content(medicalRecordsJson))
				.andReturn();
